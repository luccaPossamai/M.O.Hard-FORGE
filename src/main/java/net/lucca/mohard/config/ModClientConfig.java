...
public class ModClientConfig {
    ...
    static {
        BUILDER.push("Client configuration to moh");

        clientGuiIcons = BUILDER.comment("Vanilla style of hearts and armor level.").define("VanillaStyle", false);
        hidenEssenceStats = BUILDER.comment("Hide the essence stats tootip. Hold [SHIFT] to show.").define("HiddenStats", false);
        showHealthAmount = BUILDER.comment("Show the amount of health above the health bar.").define("HealthAmountDisplay", true);
