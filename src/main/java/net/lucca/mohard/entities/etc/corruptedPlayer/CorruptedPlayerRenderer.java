...
public class CorruptedPlayerRenderer extends LivingEntityRenderer<CorruptedPlayer, PlayerModel<CorruptedPlayer>> {
    ...
    public CorruptedPlayerRenderer(EntityRendererProvider.Context p_174557_) {
        super(p_174557_, new PlayerModel<>(p_174557_.bakeLayer(ModelLayers.PLAYER), false), 0.5F);
    ...
    public @NotNull Vec3 getRenderOffset(CorruptedPlayer p_117785_, float p_117786_) {
