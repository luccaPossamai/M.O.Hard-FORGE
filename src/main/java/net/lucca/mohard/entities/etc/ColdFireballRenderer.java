...
public class ColdFireballRenderer extends EntityRenderer<ColdFireball> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("mohard", "textures/entity/cold_fireball.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public ColdFireballRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);

    }

    protected int getBlockLightLevel(ColdFireball p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(ColdFireball p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
        p_114083_.scale(0.76F, 0.76F, 0.76F);
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull ColdFireball p_114078_) {
