...
public abstract class GenericHurtingProjectile extends Projectile {
    public double xPower;
    public double yPower;
    public double zPower;

    protected GenericHurtingProjectile(EntityType<? extends GenericHurtingProjectile> p_36833_, Level p_36834_) {
        super(p_36833_, p_36834_);
    }

    public GenericHurtingProjectile(EntityType<? extends GenericHurtingProjectile> p_36817_, double p_36818_, double p_36819_, double p_36820_, double p_36821_, double p_36822_, double p_36823_, Level p_36824_) {
    ...
    public GenericHurtingProjectile(EntityType<? extends GenericHurtingProjectile> p_36826_, LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
    ...
    public void tick() {
        ...
        if (this.level.isClientSide || (entity == null || !entity.isRemoved()) && this.level.hasChunkAt(this.blockPosition())) {
            ...
            this.applyDeltaMovement();
        }
        if(!this.level.isClientSide()) {
            List<LivingEntity> entities = this.findEntities();
            if (!entities.isEmpty()) {
                entities.forEach(livingEntity -> {
                    if(this.dealDamage(livingEntity)){
                        this.postDamage(livingEntity);
                    }
                });
            }
        }
    ...
    public abstract  List<LivingEntity> findEntities();
    public abstract boolean dealDamage(DamageSource damageSource, LivingEntity entity);
    public abstract void postDamage(LivingEntity livingEntity);
    public final boolean dealDamage(LivingEntity entity){
        return this.dealDamage(this.getDamageSource(this, this.getOwner() != null ? this.getOwner() : this), entity);
    }
    public abstract DamageSource getDamageSource(Entity entity, Entity owner);
    public abstract void applyDeltaMovement();
